...
import io.github.colusite.straytags.client.mixin.TextDisplayAccessor;
    ...
    private static int runTestUser(FabricClientCommandSource source, String targetName) {
        ...
        for (Entity passenger : passengers) {
            if (passenger instanceof Display.TextDisplay textDisplay) {
                textDisplayCount++;
                Component textData = ((TextDisplayAccessor) textDisplay).straytags$getText();
    ...
    private static int runTest(FabricClientCommandSource source, String input) {
        ...
        try {
            ...
            if (format == null || format.isBlank()) {
                ...
                Component result = MiniMessageParser.parse(format, username, clan != null ? clan : "");
