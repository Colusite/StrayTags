...
public class ServerConfig {
    ...
    public String ownFormat = "<color:#00ff00><bold>LATTE</bold></color:#00ff00> <gray>%username% [<color:#00ff00>%clan%</color:#00ff00>]";
    public String alliedFormat = "<color:#00ff00><bold>ALLY</bold></color:#00ff00> <gray>%username% [<color:#00ff00>%clan%</color:#00ff00>]";
    public String enemyFormat = "<color:#ff0000><bold>ENEMY</bold></color:#ff0000> <gray>%username% [<color:#ff0000>%clan%</color:#ff0000>]";
